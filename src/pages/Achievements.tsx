...
export default function Achievements() {
  ...
  useEffect(() => {
    if (achievements.length > 0) {
      ...
      // אם ההישג הושג בדקות האחרונות - הצג אנימציה
      if (diffMinutes < 5) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="pt-6 text-center">
            ...
            <div className="text-3xl font-bold">{gamification?.longest_streak || 0}</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {achievements.length} מתוך {Object.keys(ACHIEVEMENTS).length} הישגים
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <CardContent className="pt-6">
            ...
            {isNew && (
              <div className="absolute top-2 left-2">
                <Badge className="bg-yellow-500 text-white">חדש!</Badge>
              </div>
            )}
          </CardContent>
        </Card>
