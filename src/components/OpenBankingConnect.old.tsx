...
// ספקי בנקאות פתוחה אמיתיים בישראל
const OPEN_BANKING_PROVIDERS = {
  PEPPER: {
    id: "pepper",
    name: "Pepper",
    logo: "🌶️",
    description: "חיבור לכל הבנקים בישראל דרך Pepper",
    color: "red",
    apiEndpoint: "https://api.pepper.co.il",
    banks: ["לאומי", "הפועלים", "דיסקונט", "מזרחי", "בינלאומי", "יהב", "פאגי", "מרכנתיל", "ירושלים", "אוצר החייל", "דואר", "ועוד..."],
    creditCards: ["ישראכרט", "כ.א.ל", "מקס", "לאומי כרטיסים"],
  },
  SALT_EDGE: {
    id: "saltedge",
    name: "Salt Edge",
    ...
    color: "blue",
    apiEndpoint: "https://www.saltedge.com/api/v5",
    banks: ["בנקים ישראליים נבחרים"],
  },
  MONO: {
    id: "mono",
    name: "Mono",
    logo: "🔗",
    description: "פתרון ישראלי לחיבור בנקים",
    color: "purple",
    apiEndpoint: "https://api.mono.co.il/v1",
    banks: ["בנקים ישראליים"],
  },
};
    logo: "🏦",
    color: "green",
